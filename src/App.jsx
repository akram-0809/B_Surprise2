...
export default function BirthdayWebsite() {
  ...
  return <AnimatePresence mode="wait">{!unlocked ? <Gate key="gate" onUnlock={() => setUnlocked(true)} /> : <motion.div key="birthday" className="birthday-app" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
    ...
    <main id="top">
      <section className="hero-section page-section"><div className="hero-copy"><span className="eyebrow">A soft place made for you</span><h1>Happy birthday,<br /><em>Aeysha Shaikh.</em></h1><p className="hero-lede">Today is a little reminder that the world became gentler the day you arrived in it.</p><div className="hero-actions"><a className="gold-button" href="#nasheed"><Headphones size={16} /> Enter the Nasheed Corner</a><a className="text-link" href="#letter">Scroll slowly <ArrowDown size={15} /></a></div><TimeSinceBirth /></div><div className="moon-portrait" aria-label="A glowing portrait of Aeysha surrounded by stars"><img className="hero-photo" src={PUZZLE_IMAGE} alt="Aeysha wearing a white embroidered scarf" /><span className="orbit orbit-one" /><span className="orbit orbit-two" /><span className="orbit-dot dot-one" /><span className="orbit-dot dot-two" /><span className="orbit-dot dot-three" /><div className="hero-note">08<br /><small>SEP</small></div></div><div className="scroll-cue"><span>01 — begin here</span><div /></div></section>
